...
The _**Store A Credential API**_ enables the LOB to store, in the LOB's digital wallet, a credential that has been accepted.



{% openapi-operation spec="enterpriseapi-holder" path="/api/lob/{lob_id}/store-credential" method="post" %}
