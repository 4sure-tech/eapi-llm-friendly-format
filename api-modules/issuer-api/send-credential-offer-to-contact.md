...
The _**Send Credential Offer to Contact API**_ enables the LOB to send a credential offer to an established contact of the LOB. The credential offer will be prepared based on the protocol of the recipient.\


{% openapi-operation spec="enterpriseapi-issuer" path="/api/lob/{lob_id}/offer-to-contact" method="post" %}
