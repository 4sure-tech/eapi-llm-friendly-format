...
The _**Register Draft Schema API**_ enables the LOB to register a previously created schema draft on a public registry using the schemaDraft ID.\
\


{% openapi-operation spec="enterpriseapi-credential-management" path="/api/lob/{lob_id}/schema/register" method="post" %}
